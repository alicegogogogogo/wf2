...
class RiskTests(unittest.TestCase):
    ...
    def test_missing_signature_alone_adds_five(self) -> None:
        self._add_sbom()
        self._add_license()
        self._add_provenance()
    ...
    def test_unverifiable_signature_still_counts_as_present(self) -> None:
        # The registered signature does not match the key/digest, but
        # verification plays no part in the score.
        self._add_sbom()
        self._add_license()
        self._add_provenance()
        self._add_signature()
